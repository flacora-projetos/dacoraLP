...
A RA2 foi concluída e validada em produção: migration `20260813213535`, painel funcional `main/31f393f`, POST de edição 200 e persistência após reload, sem aplicar/aprovar/enviar. RA3 tem migration remota `20260813225317` e Preview `dpl_GwAPnqWzPv8JE6pE5WKkoW5vgqby` `READY` no commit `97505f1`, sem merge ou produção. O smoke autenticado do Preview está bloqueado porque o Supabase Auth retorna ao Site URL de produção; nenhum token foi transportado e zero contexto/sugestão/evento RA3, decisão ou envio foram gravados. O backend preserva auth, service role somente no servidor, contexto reconstruído no servidor, checksum e auditoria. Decisão e envio seguem fora. A introdução é o alvo principal da caneta mágica; C1/C2/C3 não deve ser
