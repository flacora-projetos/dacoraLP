...
A RA2 foi concluída e validada em produção: migration `20260813213535`, painel funcional `main/31f393f`, POST de edição 200 e persistência após reload, sem aplicar/aprovar/enviar. RA3 está implementada e validada localmente na branch `codex/ra3-analises-secao`, base `7e9bc67`, sem integração, Preview, produção ou migration remota. Catálogo B1–B6, lote geral, caneta local, contexto privado, suítes/build, segurança e navegador desktop/celular/PDF estão verdes. RA3 só fecha após novo GO para migration/Preview e smoke autenticado persistente. O backend preserva auth, service role somente no servidor, contexto reconstruído no servidor, checksum e auditoria. Decisão e envio seguem fora. A introdução é o alvo principal da caneta mágica; C1/C2/C3 não deve ser
