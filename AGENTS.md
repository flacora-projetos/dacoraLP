...
A RA2 foi concluída e validada em produção: migration `20260813213535`, painel funcional `main/31f393f`, POST de edição 200 e persistência após reload, sem aplicar/aprovar/enviar. **RA3 tem migration remota e Preview concluídos, mas o smoke autenticado do Preview está bloqueado**. Migration `20260813225317` foi conferida; branch `codex/ra3-analises-secao/97505f1` está pushada e Preview `dpl_GwAPnqWzPv8JE6pE5WKkoW5vgqby` `READY`. O Supabase Auth retorna ao Site URL de produção, não ao Preview; nenhum token foi transportado. Zero contexto/sugestão/evento RA3, decisão ou envio foram gravados. Auth, contexto server-side, checksum, auditoria, decisão e envio permanecem separados. A introdução do relatório continua sendo o primeiro e mais importante alvo da caneta mágica;
