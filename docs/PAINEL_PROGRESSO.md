...
**RA5 — recibo na página pública/PDF, em branch isolada em 2026-08-20:** a rota pública passa a exigir o recibo AV4 exato antes de devolver o snapshot que a mesma página imprime em PDF: identidade, checksum do documento, checksum factual e checksum aprovado precisam coincidir. Ausência ou divergência devolve indisponível; o recibo e o histórico interno não entram no JSON público. A entrega ainda não foi integrada nem publicada. Handoff: `docs/HANDOFF_RA5_RECIBO_PUBLICO_PDF_2026-08-20.md`.
